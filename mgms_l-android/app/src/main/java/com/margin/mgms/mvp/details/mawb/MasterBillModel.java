 ...
 */
public class MasterBillModel implements MasterBillContract.Model {

    private StrongLoopApi mStrongLoopApi;

    public MasterBillModel() {
    ...
    public Observable<MasterBill> requestMasterBill(String carrier, String masterBillNumber,
        ...
        return mStrongLoopApi.getMasterBill(carrier, masterBillNumber, gateway)
                .doOnNext(masterBill ->
